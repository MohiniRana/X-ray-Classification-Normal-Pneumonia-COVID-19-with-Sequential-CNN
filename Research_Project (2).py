...
# The link for my dataset is available here : https://www.kaggle.com/datasets/tawsifurrahman/covid19-radiography-database
...
#To install tensorflow, refer this article - https://caffeinedev.medium.com/how-to-install-tensorflow-on-m1-mac-8e9b91d93706
...
model.compile(optimizer='adam', loss=tf.keras.losses.BinaryCrossentropy(),metrics=['accuracy','mse',get_f1,recall_m, precision_m])
...
plt.title("Image Classification Using CNN for Normal, Covid-19 Images")
plt.legend()
plt.show()
...
plt.title("Image Classification Using CNN for Normal, Covid-19 and Pneumonia Images")
plt.legend()
plt.show()
